...
public class JavaThreadDumpAnalyserLauncher
{
  public static void main(String[] args) throws Throwable
  {
    ...
    try
    {
      try
      {
        ...
        Class<?> c = Class.forName("org.jtda.JavaThreadDumpAnalyser", true, cl);
    ...
    {
      System.err
          .println("Launch failed: Failed to find main class - org.jtda.JavaThreadDumpAnalyser");
    }
  ...
  private static ClassLoader getSWTClassloader()
  {
    ...
    try
    {
      ...
      {
        System.err.println("Launch failed: Failed to load SWT class from jar: "
            + swtFileName);
